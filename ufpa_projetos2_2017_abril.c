...
int main() {
	...
	puts("201607040031 - Emanuel Vila Seca Brito - ");
	puts("Meu Mantra: As espécies que sobrevivem não são as mais fortes, nem as mais inteligentes, e sim aquelas que se adaptam melhor às mudanças.\n");
